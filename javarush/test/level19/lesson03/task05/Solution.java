...
*/
    ...
    public static class DataAdapter implements RowItem {
        ...
        public String getCountryCode() {
            ...
            if (country.equals(countries.get("UA"))) return "UA";
            if (country.equals(countries.get("RU"))) return "RU";
            if (country.equals(countries.get("CA"))) return "CA";
            return null;
        }
        ...
        public String getContactLastName() {
            String[] fullName = contact.getName().split(" ");
            return fullName[0].replace(",", "");
        }

        @Override
        public String getDialString() {
            String phoneNumber = contact.getPhoneNumber().replace("(", "").replace(")", "").replaceAll("-", "");
