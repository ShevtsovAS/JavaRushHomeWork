...
//        System.out.println(String.format("%16s", Integer.toBinaryString(allModifiers & 0xffff)).replaceAll(" ", "0"));
//        System.out.println(String.format("%16s", Integer.toBinaryString(specificModifier & 0xffff)).replaceAll(" ", "0"));
//        System.out.println(String.format("%16s", Integer.toBinaryString((allModifiers&specificModifier) & 0xffff)).replaceAll(" ", "0"));
