...
public class Solution {
    public static void main(java.lang.String[] args) {
        ...
        try {
            File myObject = File.createTempFile("myObject", null);
            OutputStream outputStream = new FileOutputStream(myObject);
            InputStream inputStream = new FileInputStream(myObject);
            ...
            Solution.Object loadedObject = new Object();
    ...
    public static class Object {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            string1.print();
            string2.print();
            printWriter.println(myStream.toString());
            printWriter.flush();
        ...
        public void load(InputStream inputStream) throws Exception {
            //implement this method - реализуйте этот метод
            int savedCountStrings = countStrings;
            BufferedReader reader = new BufferedReader(new InputStreamReader(inputStream));
            java.lang.String[] property;
            property = reader.readLine().split("#");
            countStrings = Integer.parseInt(property[1])-1;
            string1 = new String();
            property = reader.readLine().split("#");
            countStrings = Integer.parseInt(property[1])-1;
            string2 = new String();
            countStrings = savedCountStrings;
        }
    }
