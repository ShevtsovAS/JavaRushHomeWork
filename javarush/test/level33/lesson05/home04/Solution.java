...
public class Solution {
    ...
    public static Object convertOneToAnother(Object one, Class resultClassObject) throws IOException {
        ...
        String className = one.getClass().getSimpleName().toLowerCase();
        String resultName = resultClassObject.getSimpleName().toLowerCase();
        String jSonString = writer.toString().replaceFirst(className, resultName);
