...
public class Solution {
    ...
    public static Set<? extends Animal> getAllAnimals(String pathToAnimals) {
        ...
        if (!dir.exists()) {
            System.out.println(pathToAnimals + " - не найден!");
            return null;
        }
        // Проверяем переданный путь на то что это дирректория
        if (!dir.isDirectory()) {
            System.out.println(pathToAnimals + " - не является дирректорией!");
            return null;
        }

        // Получаем список файлов с расширением .class
        ...
        for (String m : modules) {
            try {
                ...
                // Инициализируем ClassLoader для загрузки класса
                ...
                // Проверяем выполняет ли класс интерфейс Animal
                ...
                // Проверяем имеет ли класс конструктор по умолчанию
