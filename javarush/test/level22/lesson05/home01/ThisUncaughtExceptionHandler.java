...
public class ThisUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread t, Throwable e) {
        ...
        if (Solution.FIRST_THREAD_NAME.equals(t.getName())) System.out.println(getFormattedStringForFirstThread(t, e, string));
        else if (Solution.SECOND_THREAD_NAME.equals(t.getName())) System.out.println(getFormattedStringForSecondThread(t, e, string));
